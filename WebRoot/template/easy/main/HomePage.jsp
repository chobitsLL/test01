					...
					<div class="easyui-accordion" data-options="fit:true">
						<div name="res_menu_permissionManagement" title="Jpush"
							...
							<a name="" class="easyui-linkbutton"
								data-options="iconCls:'icon-emp', plain:true"
								style="width: 100%; text-align: left;"
								onclick="addTab('zTreeAPI','template/com/zTree_v3/demo/cn/index.html')">zTreeAPI</a><br>
							<a name="" class="easyui-linkbutton"
								data-options="iconCls:'icon-emp', plain:true"
								style="width: 100%; text-align: left;"
								onclick="addTab('ZtreeTest','template/easy/test/TestZtree.jsp')">ZtreeTest</a><br>
							<a name="" class="easyui-linkbutton"
								data-options="iconCls:'icon-emp', plain:true"
								style="width: 100%; text-align: left;"
								onclick="addTab('test1','template/easy/unitTest/test1.jsp')">test1</a><br>
