...
function closeDialog(value){
	...
	$.messager.alert("提示", value.msg,"info",function(){
 //跳转富文本编辑页面
		window.open("tag/ruleUeditor.do?fid="+value.fid);
	})
...
function toAdd(id,ids){
	Util.dialog("添加自定义规则","tag/addRuleInfo.do",420,200)
}
...
function toEdit(ids,rows){
	...
	if(faccepted[0]==1){
		...
		Util.dialog("编辑自定义规则","tag/selectRuleInfo.do?fid="+ids,420,200)
	}
}
//删除
