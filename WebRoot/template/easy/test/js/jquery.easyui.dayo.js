...
$.fn.textbox.defaults=$.extend({},$.fn.validatebox.defaults,{doSize:true,width:"auto",height:"auto",cls:null,prompt:"",value:"",type:"text",multiline:false,icons:[],iconCls:null,iconAlign:"right",iconWidth:18,buttonText:"",buttonIcon:null,buttonAlign:"right",label:null,labelWidth:"auto",labelPosition:"before",labelAlign:"right",inputEvents:{blur:function(e){
var t=$(e.data.target);
...
if(opts.pagination){
$.extend(_7af,{pageNo:opts.pageNumber||1,pageSize:opts.pageSize});
}
if(opts.sortName){
...
if(opts.pagination){
$.extend(_92e,{pageNo:opts.pageNumber,pageSize:opts.pageSize});
}
if(opts.sortName){
...
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"fid",textField:"fname",groupPosition:"static",groupField:null,groupFormatter:function(_a90){
return _a90;
